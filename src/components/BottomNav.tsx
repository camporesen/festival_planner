    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E0D9CC] z-40" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
      <div className="flex items-center justify-around max-w-lg mx-auto">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-wide">{t('groups')}</span>
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-wide">{t('discover')}</span>
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-wide">{t('profile')}</span>
